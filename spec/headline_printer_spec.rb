...
RSpec.describe HNReader::HeadlinePrinter, "#self.numbered_headlines" do
  context "when given headline data in the format 1 => [title, url]" do
    it "should print headlines in the format '1: Example'" do
      ...
      expect{ HNReader::HeadlinePrinter.numbered_headlines(data) }.to output("  1: Example\n").to_stdout
    end
    ...
    it "should print numbers with correct spacing" do 
      ...
      expected = "  1: Example\n 10: Example\n100: Example\n"
      expect{ HNReader::HeadlinePrinter.numbered_headlines(data) }.to output(expected).to_stdout
    end
  end
end
